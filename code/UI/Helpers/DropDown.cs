using PopupButton = RP.UI.Helpers.PopupButton;
using Popup = RP.UI.Helpers.Popup;
using PositionMode = RP.UI.Helpers.Popup.PositionMode;
...
public class DropDown : PopupButton
{
	...
	{
		Popup = new Popup( this, PositionMode.BelowStretch, 0.0f );
